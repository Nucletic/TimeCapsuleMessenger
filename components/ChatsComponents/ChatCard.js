...
const ChatCard = ({ username, profileImage, activityStatus, lastMessage, timestamp, readStatus, chatId, blockedFromOtherSide, blockedFromOurSide, lastActive }) => {
